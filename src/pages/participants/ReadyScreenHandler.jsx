  ...
  return (
    <Container className="text-center">
      ...
      <section className="mt-3">
        <p>
          dalam simulasi “Kajian pengaruh Redenominasi dalam Sistem transaksi{" "}
          <span className="fw-bold">{capitalize(data.simulationType)}</span>”
        </p>
        <div>
          <p>
            Jenis Barang:{" "}
            <span className="fw-bold">
              {data.goodsType}{" "}
              {data.goodsName ? "(" + capitalize(data.goodsName) + ")" : ""}
            </span>
          </p>
          <p>
            Jenis Inflasi: <span className="fw-bold">{data.inflationType}</span>
          </p>
        </div>
      </section>
      ...
      <section className="mt-5 py-3">
        <p>
          Klik tombol dibawah jika anda sudah dalam keadaan siap mengikuti
          simulasi
        </p>
        {ready ? (
          <>
            <Button
              variant="danger"
              className="btn-ready fs-3 px-5 py-3"
              onClick={btnHandler}
            >
              Batal Siap
            </Button>
          ...
          <Button className="btn-ready fs-3 px-5 py-3" onClick={btnHandler}>
            Saya Siap
          </Button>
        )}
      </section>
