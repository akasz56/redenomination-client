...
export default function Session() {
  ...
  function showEditSessionForm(e) {
      ...
      return (
        <Container>
          <section className="header mt-5 row">
            <div className="col-9">
              ...
              <Link
                ...
                to={"/simulations/" + data.simulation.id}
              >
                {" "}
                {"<"} Kembali
              </Link>
          ...
          <section className="mt-4 text-center">
            <p>
              Timer : <span className="fw-bold">{data.timer} menit</span>
            </p>
          </section>
          ...
          <section className="my-5">
            <h1>Hapus Ulangan</h1>
            <Button variant="danger" onClick={showDeleteSessionForm}>
              Hapus Ulangan
            </Button>
          </section>
          ...
          <Modal show={modalEdit} onHide={showEditSessionForm}>
            <form onSubmit={submitEditSession}>
              ...
              <Modal.Footer>
                <Button variant="secondary" onClick={showEditSessionForm}>
                  Close
                </Button>
            ...
            <form onSubmit={confirmDelete}>
              ...
              <Modal.Body>
                <Form.Group controlId="confirm">
                  ...
                  <Form.Control
                    required
                    placeholder={capitalize(data.sessionType)}
                    name="confirm"
                  />
                </Form.Group>
              </Modal.Body>
