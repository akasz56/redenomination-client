...
export default function Summary(props) {
            ...
            datasets: [
              {
                ...
                data: res.data.phaseSummary.map(
  ...
  const nameArr = useMemo(
    () => [data.simulation.token, data.sessionType],
    [data]
  );
  ...
  return (
    <>
      ...
      <UnitProfit
        ...
        budget={data.simulation.simulationBudget}
        isSession
      />
    </>
  );
